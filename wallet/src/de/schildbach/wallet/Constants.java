...
public final class Constants {
    ...
    public static final String WALLET_NAME_CURRENCY_CODE = NETWORK_PARAMETERS.getId()
            .equals(NetworkParameters.ID_MAINNET) ? "jadepay" : "tjadepay";
    ...
    public static final String REPORT_EMAIL = "jadepay8@gmail.com";

    /** Subject line for manually reported issues. */
    public static final String REPORT_SUBJECT_ISSUE = "Jadepay Wallet: Reported issue";
    ...
    public static final String SOURCE_URL = "https://github.com/jadepay/" + CoinDefinition.coinName.toLowerCase() + "-wallet";
    public static final String BINARY_URL = "https://github.com/jadepay/" + CoinDefinition.coinName.toLowerCase() + "-wallet/releases";
    ...
    //Jadepay Specific
    public static long EARLIEST_HD_SEED_CREATION_TIME = 1528207200l;

    public static String WALLET_URI_SCHEME = "jadepaywallet";
